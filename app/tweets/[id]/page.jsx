...
export default function Home() {
    ...
    useEffect(() => {
        const fetchTweets = async () => {
            ...
            try {
                const response = await fetch(`http://localhost:5000/tweets/get-all-tweets/${twitterId}`);
    ...
    const handleDeleteTweet = async () => {
        ...
        await fetch(`http://localhost:5000/tweets/delete-tweet/${selectedTweet}`, { method: "DELETE" });
    ...
    const handleAddTweet = async () => {
        if (!tweetText) return;
        const response = await fetch("http://localhost:5000/tweets/add-tweet", {
            method: "POST",
    ...
    const handleEditTweet = async () => {
        ...
        await fetch(`http://localhost:5000/tweets/edit-tweet/${selectedTweet}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/tweets/generate-pdf?user_id=${twitterId}`, {
                method: "GET"
            });
